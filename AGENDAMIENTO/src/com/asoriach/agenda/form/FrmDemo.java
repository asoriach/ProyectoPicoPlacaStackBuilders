...
public class FrmDemo extends JFrame {
	...
	public FrmDemo() {
		...
		GridBagConstraints gbc_txtDemo = new GridBagConstraints();
		gbc_txtDemo.insets = new Insets(0, 0, 5, 5);
		gbc_txtDemo.fill = GridBagConstraints.HORIZONTAL;
		gbc_txtDemo.gridx = 6;
		gbc_txtDemo.gridy = 3;
		panel.add(txtDemo, gbc_txtDemo);
