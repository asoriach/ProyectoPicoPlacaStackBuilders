...
-- -----------------------------------------------------
-- Table `sysmed`.`centro_atencion_has_doctor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sysmed`.`centro_atencion_has_doctor` (
  `centro_atencion_id_cen` INT NOT NULL,
  `doctor_id_doc` INT NOT NULL,
  PRIMARY KEY (`centro_atencion_id_cen`, `doctor_id_doc`),
  INDEX `fk_centro_atencion_has_doctor_doctor1_idx` (`doctor_id_doc` ASC),
  INDEX `fk_centro_atencion_has_doctor_centro_atencion1_idx` (`centro_atencion_id_cen` ASC),
  CONSTRAINT `fk_centro_atencion_has_doctor_centro_atencion1`
    FOREIGN KEY (`centro_atencion_id_cen`)
    REFERENCES `sysmed`.`centro_atencion` (`id_cen`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_centro_atencion_has_doctor_doctor1`
    FOREIGN KEY (`doctor_id_doc`)
    REFERENCES `sysmed`.`doctor` (`id_doc`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `sysmed`.`cita` (
  ...
  `centro_cita` VARCHAR(45) NOT NULL,
  `verificar_seguro` INT NOT NULL,
  `tipo_cita_id_tipo_cita` INT NOT NULL,
  `paciente_id_pac` INT NOT NULL,
  `centro_atencion_has_doctor_centro_atencion_id_cen` INT NOT NULL,
  `centro_atencion_has_doctor_doctor_id_doc` INT NOT NULL,
  PRIMARY KEY (`id_cita`),
  INDEX `fk_cita_tipo_cita1_idx` (`tipo_cita_id_tipo_cita` ASC),
  INDEX `fk_cita_paciente1_idx` (`paciente_id_pac` ASC),
  INDEX `fk_cita_centro_atencion_has_doctor1_idx` (`centro_atencion_has_doctor_centro_atencion_id_cen` ASC, `centro_atencion_has_doctor_doctor_id_doc` ASC),
  ...
  CONSTRAINT `fk_cita_paciente1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cita_centro_atencion_has_doctor1`
    FOREIGN KEY (`centro_atencion_has_doctor_centro_atencion_id_cen` , `centro_atencion_has_doctor_doctor_id_doc`)
    REFERENCES `sysmed`.`centro_atencion_has_doctor` (`centro_atencion_id_cen` , `doctor_id_doc`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
